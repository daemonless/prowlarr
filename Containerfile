...
LABEL org.opencontainers.image.title="Prowlarr" \
      org.opencontainers.image.description="Indexer manager and proxy for Sonarr, Radarr, and other *arr applications — centralizes indexer configuration across your media stack." \
